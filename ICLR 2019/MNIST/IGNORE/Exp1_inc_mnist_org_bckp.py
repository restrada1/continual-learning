...
import visdom
vis = visdom.Visdom()
vis.delete_env('MNIST_TEST_SET') #If you want to clear all the old plots for this python Experiments.Resets the Environment
vis = visdom.Visdom(env='MNIST_TEST_SET')
# Execution flags
Flags = {}
...
for mnsit_class in range(0,10):
    ...
    with open('Collected_Data/Actual_Accuracy'+str(mnsit_class), 'wb') as fp:
