...
import visdom
vis = visdom.Visdom()
vis.delete_env('Inc_MNIST_Fixed_Iter_333_skills_testset') #If you want to clear all the old plots for this python Experiments.Resets the Environment
vis = visdom.Visdom(env='Inc_MNIST_Fixed_Iter_333_skills_testset')
# Execution flags
Flags = {}
