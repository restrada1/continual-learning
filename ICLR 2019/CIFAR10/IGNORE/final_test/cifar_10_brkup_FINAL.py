...
def CAE_AE_TRAIN(shapes,task_samples,iterations):
    ...
    final_dataframe_1.to_hdf(str(len(task_samples_copy))+'_MSE_final','key1')
    return accuracies
#####################################################################################################################
...
for cifar_class in range(0,10):
    ...
    with open('allAcc_resendskills_cae2_FINAL_'+str(cifar_class), 'wb') as fp:
        pickle.dump(allAcc, fp)

    with open('Actual_Accuracy_resendskills_FINAL_'+str(cifar_class), 'wb') as fp:
        pickle.dump(Actual_Accuracy, fp)

    with open('threshold_FINAL_'+str(cifar_class), 'wb') as fp:
